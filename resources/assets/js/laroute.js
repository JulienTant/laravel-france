(function () {
    ...
    var laroute = (function () {
        ...
        var routes = {
            ...
            routes : [{"host":"homestead.app","methods":["GET","HEAD"],"uri":"\/","name":"forums.index","action":"ForumsController@topics"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"c\/{slug}","name":"forums.by-category","action":"ForumsController@topics"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"search","name":"forums.search","action":"ForumsController@search"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"t\/{categorySlug}\/{topicSlug}","name":"forums.show-topic","action":"ForumsController@topic"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"m\/{messageId}","name":"forums.show-message","action":"ForumsController@message"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"sujets-suivis","name":"my-forums.watched-topics","action":"MyForumController@watchedTopics"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"mes-sujets","name":"my-forums.my-topics","action":"MyForumController@myTopics"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"mes-messages","name":"my-forums.my-messages","action":"MyForumController@myMessages"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"socialite\/{driver}","name":"socialite.login","action":"SocialiteController@redirectToProvider"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"socialite\/{driver}\/callback","name":"socialite.callback","action":"SocialiteController@handleProviderCallback"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"logout","name":"logout","action":"SocialiteController@logout"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"slack","name":"slack","action":"SlackController@index"},{"host":"homestead.app","methods":["POST"],"uri":"slack","name":"slack.invite","action":"SlackController@invite"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"contact","name":"contact","action":"ContactController@index"},{"host":"homestead.app","methods":["POST"],"uri":"contact","name":"contact.send","action":"ContactController@send"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"contact\/sent","name":"contact.sent","action":"ContactController@sent"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"profile","name":"profile","action":"ProfileController@index"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"profile\/change-username","name":"profile.change-username","action":"ProfileController@changeUsername"},{"host":"homestead.app","methods":["POST"],"uri":"profile\/change-username","name":"profile.change-username.post","action":"ProfileController@postChangeUsername"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"profile\/change-avatar","name":"profile.change-avatar","action":"ProfileController@changeAvatar"},{"host":"homestead.app","methods":["POST"],"uri":"profile\/change-avatar","name":"profile.change-avatar.post","action":"ProfileController@postChangeAvatar"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"profile\/forums","name":"profile.forums","action":"ProfileController@forums"},{"host":"homestead.app","methods":["POST"],"uri":"profile\/forums","name":"profile.forums.post","action":"ProfileController@postForums"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"admin\/users","name":"admin.users.index","action":"Admin\UserControler@index"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"admin\/users\/{user}\/groups","name":"admin.users.groups","action":"Admin\UserControler@groups"},{"host":"homestead.app","methods":["POST"],"uri":"admin\/users\/{user}\/groups","name":"admin.users.save-groups","action":"Admin\UserControler@saveGroups"},{"host":"homestead.app","methods":["POST"],"uri":"api\/renderMarkdown","name":"api.markdown","action":"Api\MarkdownController@render"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"api\/forums\/{topicId}\/watch","name":"api.forums.watch","action":"Api\ForumsController@watch"},{"host":"homestead.app","methods":["POST"],"uri":"api\/forums\/{topicId}\/toggle-watch","name":"api.forums.toggle-watch","action":"Api\ForumsController@toggleWatch"},{"host":"homestead.app","methods":["POST"],"uri":"api\/forums\/post","name":"api.forums.post","action":"Api\ForumsController@post"},{"host":"homestead.app","methods":["POST"],"uri":"api\/forums\/{topicId}\/reply","name":"api.forums.reply","action":"Api\ForumsController@reply"},{"host":"homestead.app","methods":["GET","HEAD"],"uri":"api\/forums\/{topicId}\/messages\/{messageId}","name":"api.forums.message","action":"Api\ForumsController@message"},{"host":"homestead.app","methods":["PUT"],"uri":"api\/forums\/{topicId}\/messages\/{messageId}","name":"api.forums.message.update","action":"Api\ForumsController@updateMessage"},{"host":"homestead.app","methods":["DELETE"],"uri":"api\/forums\/{topicId}\/messages\/{messageId}","name":"api.forums.message.delete","action":"Api\ForumsController@deleteMessage"},{"host":"homestead.app","methods":["POST"],"uri":"api\/forums\/{topicId}\/messages\/{messageId}\/solve_topic","name":"api.forums.message.solved_topic","action":"Api\ForumsController@solveTopic"}],
